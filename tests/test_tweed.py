...
class TweedRunnerTests(unittest.TestCase):
    ...
    def test_needs_input_receipt_gets_session_id(self):
        ...
        self.assertIn("the Input below is only a Linear issue identifier", observed["prompt"])
        self.assertIn("verified Linear comment is the sole cross-phase handoff", observed["prompt"])
